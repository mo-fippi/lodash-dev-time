 ...
 * method to immediately invoke them. Provide options to indicate whether func should be
 * invoked on the leading and/or trailing edge of the wait timeout. The func is invoked
 * with the last arguments provided to the debounced function. Subsequent calls to the
